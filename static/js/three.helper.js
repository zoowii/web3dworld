...
(function() {
  var Set, defaultSceneJson, defaultSceneJsonUrl, directExtendObjProperties, helper, jsonStore, meshCount, processLoadedSceneJson, static_url, store;
  ...
  helper.preprocessJsonResource = function(json) {};
  ...
  helper.loadWallFromJson = function(json) {
  ...
  helper.loadLightFromJson = function(json) {
    var light;
  ...
  helper.updateMeshFromJson = function(mesh, json) {
    ...
    if (mesh.name === void 0) {
      return mesh.name = "Mesh" + (++meshCount);
    }
  };
