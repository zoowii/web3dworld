define(function (require, exports, module) {
    ...
    helper.directExtendObjProperties = directExtendObjProperties;
    ...
    helper.loadMaterialFromJson = function (json) {
        ...
        directExtendObjProperties(params, json, ['version', 'transparent', 'opacity']);
        if(!json.map && json.color) {
    ...
    helper.parseMaterialToJson = function (material) {
        ...
        if (material.map) {
            ...
            if (material.map.repeat) {
                mapJson.repeat = {
                    width: material.map.repeat.x,
                    height: material.map.repeat.y
                };
            }
            json.map = mapJson;
        }
    ...
    helper.parseObject3DToJson = function (obj) {
        ...
        switch (obj.meshType) {
            case 'wall':
            {
                ...
                directExtendObjProperties(json, obj, ['receiveShadow', 'doubleSided', 'castShadow', 'meshName', 'version', 'xtype']);
